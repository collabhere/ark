...
export const FormSectionConnection: FC<AdvancedConnectionFormProps> = (props) => {
	...
	return (
		<div className="form">
			<FormGroup helperText={<span>{"Select the type of connection."}</span>} label="Type" labelFor="connection-type">
				<div className="input-field">
					<Button
						...
						text={connectionData?.type === "replicaSet" ? "Replica Set" : "Direct connection"}
					/>
				</div>
			</FormGroup>
			<div>
				<FormGroup label="Name">
					<div className="input-field">
						<InputGroup value={connectionData?.name} onChange={(e) => editConnection("name", e.target.value)} />
					</div>
				</FormGroup>
			</div>
						...
						<FormGroup label="Port">
							<div className="input-field">
								<InputGroup
									...
									onChange={(e) =>
										editConnection("host.0", { port: e.target.value ? parseInt(e.target.value) : 27017 })
									}
								/>
							</div>
						</FormGroup>
			...
			{connectionData.type === "replicaSet" && (
				<FormGroup label="Hosts" helperText="Use a new line to separate hosts.">
					<div className="input-field">
						<TextArea
