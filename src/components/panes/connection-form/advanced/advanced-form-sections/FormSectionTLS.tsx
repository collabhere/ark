	...
	return <div className="form">
		...
		<FormGroup helperText={
			connectionData.tlsMethod === "self-signed"
				...
				: <span>
					...
					<a rel="noreferrer" target={"_blank"} href="https://www.mongodb.com/docs/mongodb-shell/reference/options/#tls-options">
						{"here"}
					</a>
					{"."}
				</span>
			...
			<div className="input-field">
				<Button
					...
					text={connectionData.tlsMethod === "self-signed"
		...
		{connectionData.tlsMethod === "ca-certificate" && (
			<div>
				...
				<FormGroup
					helperText=""
					label="Certificate (--tlsCertificateFile)"
				>
					<FileInput
						fill
						disabled={!connectionData.options.tls}
				...
				<div className="flex-inline">
					<FormGroup
						helperText="Use a client key (.pem) file."
						label="Client Key (--tlsCertificateKeyFile)"
					>
						<FileInput
							fill
							disabled={!connectionData.options.tls}
