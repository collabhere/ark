...
export const FormSectionAuthentication: FC<AdvancedConnectionFormProps> = (props) => {
	...
	return <div className="form">
		...
		<FormGroup helperText={<div>
			<span>{"Note that Ark does not configure other requirements for the chosen mechanism. More on auth mechanisms "}</span><a rel="noreferrer" href="https://www.mongodb.com/docs/drivers/node/current/fundamentals/authentication/mechanisms/" target={"_blank"}>{"here"}</a><span>.</span>
		</div>} label="Authentication Mechanism">
			<div className="input-field">
				<Button
					size="small"
